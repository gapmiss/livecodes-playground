<script lang="ts">
	...
	let handleTags: HTMLTextAreaElement;

	onMount(() => {
		setIcon(tagsNotice,"info");
	});
</script>
...
<div class="setting-item tags-setting">
	<div class="setting-item-info">
		...
		<div class="setting-item-description">
			<span class="setting-item-notice" aria-label="Info" bind:this={tagsNotice}></span>
			<span>Use alpha-numeric with dashes and/or underscores ONLY, for compatibility with Obsidian's tags features.</span>
		</div>
	</div>
