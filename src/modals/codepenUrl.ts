...
type CodepenUrlCallback = (text: string | null) => void;

export class CodepenUrlModal extends Modal {
  title: string | null;
  message: string;
  messagDefault: string;
  placeholder: string;
  multiLine: boolean;
  callback: CodepenUrlCallback;
...
export async function codepenUrlModal(
  app: App,
  title: string | null,
  message: string,
  messagDefault: string = "",
