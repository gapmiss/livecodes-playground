export const helpModals = {
  ...
  { 
    title: 'App URL', 
    description: '<p>Load the playground from a custom URL (e.g. <a href="https://livecodes.io/docs/features/self-hosting" data-tooltip-position="top" aria-label="https://livecodes.io/docs/features/self-hosting" target="_blank" rel="noopener" class="external-link">self-hosted app</a>, <a href="https://livecodes.io/docs/features/permanent-url" data-tooltip-position="top" aria-label="https://livecodes.io/docs/features/permanent-url" target="_blank" rel="noopener" class="external-link">permanent URL</a>). Trailing slash <strong>/</strong> is required.</p><p>Default: <strong class="appurl-copy" aria-label="Click to copy" data-tooltip-position="top">https://next.livecodes.io/</strong>' 
  },
  shortUrl:
  { 
  ...
  sponsorship:
  {
    ...
    description: '<p class="sponsorship-content">If this plugin adds value for you and you would like to help support continued development, please consider sponsoring the developers.</p>'
  }
}
